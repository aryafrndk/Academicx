        ...
        <Container>
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <button
                className="btn btn-dark btn-lg rounded-1 me-2 mb-xs-0 mb-2 mb-4 animate__animated animate__fadeInUp animate__delay-1s"
                onClick={() => navigate("/kelas")}
              >
                Lihat Kelas
              </button>
              <button className="btn btn-outline-dark btn-lg rounded-1 me-2 mb-xs-0 mb-2 mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Lihat Promo
              </button>
            </Col>
              ...
              return (
                ...
                >
                  <img
                    src={kelas.image}
                    alt="unsplash.com"
                    className="mb-5 rounded-top w-100"
                  />
